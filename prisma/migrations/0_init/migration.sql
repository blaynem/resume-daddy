...
-- CreateTable
CREATE TABLE "public"."resumePredictions" (
    "id" UUID NOT NULL DEFAULT uuid_generate_v4(),
...
CREATE TABLE "public"."jobs" (
    ...
    "interpreted_responsibilities" TEXT,
    "industry" TEXT,
    "achievements" TEXT,
...
-- CreateTable
CREATE TABLE "public"."_jobsToskills" (
    "A" UUID NOT NULL,
    "B" UUID NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_jobsToskills_AB_unique" ON "public"."_jobsToskills"("A", "B");

-- CreateIndex
CREATE INDEX "_jobsToskills_B_index" ON "public"."_jobsToskills"("B");

-- AddForeignKey
ALTER TABLE "public"."resumePredictions" ADD CONSTRAINT "resumePredictions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."skills" ADD CONSTRAINT "skills_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."interests" ADD CONSTRAINT "interests_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_jobsToskills" ADD CONSTRAINT "_jobsToskills_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."jobs"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_jobsToskills" ADD CONSTRAINT "_jobsToskills_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."skills"("id") ON DELETE CASCADE ON UPDATE CASCADE;
